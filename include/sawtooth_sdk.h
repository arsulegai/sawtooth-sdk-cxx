...
class Transaction final {
 public:
    Transaction(
            ...
            StringPtr payload,
            StringPtr signature,
            StringPtr raw_header
    ): header_(header), payload_(payload), signature_(signature), raw_header_(raw_header) {
    }
    ...
    const std::string& raw_header() const {
        return *(this->raw_header_);
    }
